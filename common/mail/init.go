...
func NewMailManager(email string, password string, host string, port int, BaseUrl string) *MailManager {
	return &MailManager{Email: email, Password: password, SmtpHost: host, SmtpPort: port, BaseURL: BaseUrl}
}
